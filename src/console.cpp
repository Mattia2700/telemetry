...
Console::~Console()
{
    ...
    // DebugMessage("System logs are closed");
}
...
// void Console::LogToFile(const string text, bool print_message)
// {
//     console_messages << text << endl;

//     if (print_message)
//     {
//         string message = MakeTextColor(BOLD, TEXT, header_color, INFO) + SEPARATOR + MakeTextColor(NORMAL, TEXT, text_color, text);
//         cout << message << endl;
//     }
// }
