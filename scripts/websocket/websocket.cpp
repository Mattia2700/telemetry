...
public:
    ...
    void run(const std::string & uri) {
        ...
        websocketpp::lib::thread telemetry_thread(&Client::telemetry_loop,this);
    ...
    void on_open(websocketpp::connection_hdl) {
        ...
        d.Accept(*w);
        m_client.send(m_hdl,sb.GetString(),websocketpp::frame::opcode::text,ec);
    ...
    void telemetry_set_data(string data){
      scoped_lock guard(m_lock);
      to_send_data = data;
    }
    ...
    void telemetry_loop() {
        ...
        while(1) {
            ...
            d.AddMember("data", Value().SetString("Should be another json string containing sensors data"), alloc);
            d.Accept(*w);

            m_client.get_alog().write(websocketpp::log::alevel::app, sb.GetString());
            m_client.send(m_hdl,sb.GetString(),websocketpp::frame::opcode::text,ec);
